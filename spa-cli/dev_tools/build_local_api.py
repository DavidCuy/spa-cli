...
def _slugify_path(path: str) -> str:
    """
    Convierte un path OpenAPI (p.ej. '/v1/vehicles/{vin}')
    en un nombre seguro para función: 'v1_vehicles_vin'
    """
...
def generate_fastapi_routes_from_openapi_path(endpoint_def: Dict) -> str:
    """
    Recibe el dict (ej. resultado de yaml.safe_load) y devuelve un string
    con los stubs de FastAPI en el formato deseado.
...
def build_local_api():
    ...
    import_lambdas, endpoint_list = get_api_config()
...
{IMPORT_ENDPOINTS}
    ...
    output_path = "src/api_local/router.py"
